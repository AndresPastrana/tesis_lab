import { allowed_formats } from "@/app/const";
import { getMinioConfig } from "./../utils/getMinioConfig";
...
export default class MinioService {
  ...
  public static getInstance(config?: ClientOptions): MinioService {
  ...
  public async getFiles(bucketName: string) {
    try {
